#exec(open('ss/code/loaddata2.py').read())
    ...
    for x in range(0,d1.shape[1],jump):
        if(x+wid < d1.shape[1]):
            ...
            if(not data.any()):
                ...
                tempdata =np.concatenate(tempdata1)
                data = (tempdata)
...
spio.savemat('/home/saurabh/scratch/saved_data/loaddata_rest90d.mat', {'a': data})
spio.savemat('/home/saurabh/scratch/saved_data/slabels_rest90d.mat', {'s': slabels}) #pd or HC
spio.savemat('/home/saurabh/scratch/saved_data/tlabels_rest90d.mat', {'t': tlabels}) #restomg
spio.savemat('/home/saurabh/scratch/saved_data/mlabels_rest90d.mat', {'m': mlabels}) #onmed or offmed
spio.savemat('/home/saurabh/scratch/saved_data/sid90d.mat', {'m': sid}) #onmed or offmed
